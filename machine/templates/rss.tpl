    ...
    {foreach $newMachineList as $m}
      <item>
        ...
        {if !empty($mail)}
          {if !empty($m.top_img)}
            <enclosure
              url="https://s3-ap-northeast-1.amazonaws.com/machinelife/machine/public/media/machine/thumb_{$m.top_img}"
              length="100000" type="image/jpeg"></enclosure>
            <media:content
              url="https://s3-ap-northeast-1.amazonaws.com/machinelife/machine/public/media/machine/thumb_{$m.top_img}"
        ...
        {else}
          {if !empty($m.top_img)}
            <enclosure url="https://s3-ap-northeast-1.amazonaws.com/machinelife/machine/public/media/machine/{$m.top_img}"
              length="100000" type="image/jpeg"></enclosure>
            <media:content url="https://s3-ap-northeast-1.amazonaws.com/machinelife/machine/public/media/machine/{$m.top_img}"
              medium="image" type="image/jpeg" />
          {/if}
