...
<table class="member form">
  ...
  <tr class="large_genre">
    ...
    <td>
      <input type="text" name="large_genre" value="{$largeGenre.large_genre}"
        placeholder="中ジャンル名" required />
    </td>
  </tr>
  ...
  <tr class="large_genre">
    <th>中ジャンル名(カナ)</th>
    <td>
      <input type="text" name="large_genre_kana" value="{$largeGenre.large_genre_kana}"
        placeholder="中ジャンル名(カナ)" />
    </td>
  </tr>
  ...
  <tr class="order_no">
    ...
    <td>
      <input type="number" class="digits num" name="order_no" value="{$largeGenre.order_no}" 
