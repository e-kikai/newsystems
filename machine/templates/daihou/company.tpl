...
*}
  ...
  <div class="row justify-content-center">
    ...
    <img src='./imgs/company_sagyo.jpeg' alt="中古機械登録会社 {$company.company} {$company.addr1} {$company.addr2} {$company.addr3}" class="w-100" />
    </div>
  ...
  <div class="row">
    <div class="col-md-6 order-md-2">
        <table class="table table-striped">
            ...
            <td class="col-8">
                ...
                LINEWORKS : <br />
                <a href="https://works.do/R/ti/p/sakai.takeapersonforgranted@daihou" target="_blank" class="text-break">https://works.do/R/ti/p/sakai.takeapersonforgranted@daihou</a>
            </td>
            </tr>
            <tr>
    ...
    <div class="col-md-6 order-md-1 px-4">
      ...
      *}
      <img src='./imgs/company_01.jpeg' alt="中古機械登録会社 {$company.company} {$company.addr1} {$company.addr2} {$company.addr3}" class="w-100" />
