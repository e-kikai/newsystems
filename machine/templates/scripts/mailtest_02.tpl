...
<body
  style="margin:0;color:#333;font-size:13px;line-height:1.4;font-family:'メイリオ', Meiryo, 'Lucida Grande', Verdana, 'ヒラギノ角ゴ Pro W3', 'Hiragino Kaku Gothic Pro';">

  <a href='{$_conf.site_uri}' style="margin: 8px;"><img src='{$_conf.site_uri}imgs/logo_zenkiren_mini.png'
      alt="全機連 中古機械情報" style="border:0;" /></a>

  <h1
    style="border-left:6px solid #147543;margin: 0 auto 6px auto;height: 20px;line-height: 20px;margin: 8px;font-size: 18px;font-weight: bold;text-indent: 13px;">
  ...
  <div
    style="margin-top: 8px;width: 100%;height: 30px;line-height: 30px;text-align: center;background: #111;color: #FFF;">
    Copyright &copy; {$smarty.now|date_format:"%Y"} <a href="http://www.zenkiren.net" target="_blank"
      style="color:#FFF;">全日本機械業連合会</a> All Rights Reserved.
  </div>
</body>
