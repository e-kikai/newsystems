  ...
  {if !empty($period)}
    <form method="GET" id="period_form">
      <div class='period_area'>
        ...
        <li>
          <label><input type="radio" name="pe" value="1" {if !empty($period) && $period==1}checked="checked"
              {/if} />1日前</label>
        </li>
        <li>
          <label><input type="radio" name="pe" value="2" {if !empty($period) && $period==2}checked="checked"
              {/if} />2日前</label>
        </li>
        <li>
          <label><input type="radio" name="pe" value="3" {if !empty($period) && $period==3}checked="checked"
              {/if} />3日前</label>
        </li>
        <li>
          <label><input type="radio" name="pe" value="7" {if !empty($period) && $period==7}checked="checked"
              {/if} />1週間</label>
        </li>
        <li>
          <label><input type="radio" name="pe" value="14" {if !empty($period) && $period==14}checked="checked"
              {/if} />2週間</label>
        </li>
        <li>
          <label><input type="radio" name="pe" value="31" {if !empty($period) && $period==31}checked="checked"
              {/if} />1ヶ月</label>
        </li>
