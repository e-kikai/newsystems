...
{block 'main'}
  ...
  *}
      ...
      <tr class="title">
        <th>タイトル</th>
        <td>
          <input type="text" name="title" class="title" value="{$memo.title}" placeholder="買いのタイトル" />
        </td>
      </tr>
      ...
      <tr class="datetime">
        <th>日時</th>
        <td>
          <input type="datetime" name="datetime" class="datetime" value="{$memo.datetime}" placeholder="日時" />
        </td>
      </tr>
  ...
  *}
        ...
        <table class="memo form">
          <tr class="memo">
            <th>メモ</th>
            <td>
              <textarea name="memo" class="memo" placeholder="メモ内容を入力してください">{$memo.memo}</textarea>
            </td>
          </tr>
        </table>
