    ...
    <script type="text/javascript">
      ...
      $(function() {
        $('button.submit').click(function() {
          ...
          //// エラー表示 ////
          if (e != '') { alert(e);
            sendEvent('form_error'); return false; }
          ...
          $.post('/ajax/contact.php', {
            ...
            if (res != 'success') { alert(res);
              sendEvent('server_error'); return false; }
          ...
          <tr class='mess'>
            ...
            <td>
              ...
              <textarea name='message'
                class='other_message'>{if !empty($mes)}{$mes}{/if}{* {if !empty($bidMachineId)}Web入札会出品番号 : {$bidMachineId}{/if} *}</textarea>
            </td>
          </tr>
