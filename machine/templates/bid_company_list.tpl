...
#map1 td.cr01 { background: #99FF00; }
#map1 td.cr02 { background: #CCFF99; }
#map1 td.cr03 { background: #00FF3C; }
#map1 td.cr04 { background: #FFFF99; }
#map1 td.cr05 { background: #FFCC66; }
#map1 td.cr06 { background: #66FFFF; }
#map1 td.cr07 { background: #CCCCFF; }
#map1 td.cr08 { background: #CCFFFF; }
#map1 td.cr09 { background: #FFCCFF; }
...
<table class="tablemap" id="map1">
  ...
  <tr><td colspan="18" class="sea frame"> </td></tr>
  <tr>
    <td colspan="15" class="sea"></td>
