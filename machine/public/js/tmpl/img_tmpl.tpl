      ...
      <div class='image_carousel'>
        <ul class='imgs'>
          <li><a class='zoom' href='/machine_detail.php?m={{>id}}'  target="_blank">
            <img class="top_image lazy" src='imgs/blank.png' data-original="media/machine/{{>top_img}}" alt="" />
          </a></li>
          
          {{for _render_imgs}}
            <li><a class='zoom' href='/machine_detail.php?m={{>id}}'  target="_blank">
              <img class="lazy" src='imgs/blank.png' data-original="media/machine/{{>img}}" alt="" />
            </a></li>
          {{/for}}
