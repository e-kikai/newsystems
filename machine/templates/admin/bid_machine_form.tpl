      ...
      <tr class="carryout_note">
        ...
        <td>
          <textarea name="carryout_note" class="carryout_note"
            placeholder="引取時に関する、留意事項を入力してください">{$machine.carryout_note}</textarea>
        </td>
      </tr>
        ...
        <td>
          ...
          <div class="upload_img">
            {if !empty($machine.top_img)}
              <div class="img">
                <label><input type="checkbox" name="top_img_delete" class="top_img_delete"
                    value="{$machine.top_img}" />削除</label><br />
