            ...
            <table class="spec">
              ...
              <tr class="spec">
                ...
                <td>
                  {if !empty($others)}
                    <div class="others">
                      {$others|escape|regex_replace:"/\s\|\s/":'</div> | <div class="others">'|regex_replace:"/alert\((.*)\)/":'<span style="color:red;">$1</span>' nofilter}
                    </div> |
                  {/if}
                  {if !empty($machine.spec)}
                    <div class="others">
                      {$machine.spec|escape|regex_replace:"/(\s\|\s|\,\s)/":'</div> | <div class="others">'|regex_replace:"/alert\((.*)\)/":'<span style="color:red;">$1</span>' nofilter}
                    </div>
                  {/if}
                </td>
              </tr>
