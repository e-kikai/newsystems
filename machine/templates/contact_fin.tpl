...
{block 'main'}
  <div class='terms'>
    ...
    <br />
    今後とも、<a href="{$_conf.website_uri}" target="_blank">{$_conf.copyright}</a>および<a
      href="/">マシンライフ</a>をよろしくお願いいたします。<br /><br />
  </div>
    ...
    <noscript>
      <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt=""
          src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/977898861/?value=0&guid=ON&script=0" />
      </div>
    </noscript>
  {/if}
