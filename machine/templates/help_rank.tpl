...
<div class="help_contents">
  ...
  <p>
    ...
    全機連の会員様であれば、自動的にC会員のサービスがご利用可能となっています。<br />尚、アカウント、パスワードがご不明な場合は事務局へお問い合せ下さい。
  </p>
  ...
  <p>
    ...
    <a href="media/pdf/help_rank.pdf" style="padding-left:20px;background: url('/imgs/pdficon_small.png') no-repeat;">会員区分変更届(PDF)</a>
  </p>
</div>
{/block}
