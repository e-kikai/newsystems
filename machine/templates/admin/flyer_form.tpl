  ...
  <form class="machine" method="post" action="admin/flyer_do.php" enctype="multipart/form-data">
    ...
    <table class="machine form">
      <tr class="name">
        ...
        <td>
          <input type="text" name="title" class="name default" value="{$flyer.title}" placeholder="タイトル" required />
        </td>
      </tr>
      ...
      <tr class="name">
        ...
        <td>
          <input type="text" name="subject" class="name default" value="{$flyer.subject}" placeholder="メール表題" required />
        </td>
      </tr>
      ...
      <tr class="name">
        ...
        <td>
          <input type="text" name="from_name" class="from_name" value="{$flyer.from_name}" placeholder="送信元名" required />
        </td>
      </tr>
      <tr class="mail">
        <th>送信元メールアドレス<span class="required">(必須)</span></th>
        <td>
          <input type="text" name="from_mail" class="from_mail" value="{$flyer.from_mail}" placeholder="xxx@yyy.com"
            required />
        </td>
      </tr>
      ...
      <tr class="top_img">
        ...
        <td>
          ...
          <iframe name="upload" class="upload" src="../ajax/upload.php?c=top_img&t=image/*" frameborder="0"
      ...
      <tr class="spec">
        ...
        <td>
          <textarea name="design_main_text" class="design_main_text"
            placeholder="大きい文字で表示される、メインの内容を記述してください">{$flyer.design_main_text}</textarea>
        </td>
      </tr>
      ...
      <tr class="spec">
        ...
        <td>
          <textarea name="design_sub_text" class="design_sub_text"
            placeholder="小さい文字でメインの次に表示される内容を記述してください">{$flyer.design_sub_text}</textarea>
        </td>
      </tr>
      ...
      <tr class="spec">
        ...
        <td>
          <textarea name="design_bottom_text" class="design_bottom_text"
            placeholder="リンクボタンの下に表示される内容を記述してください">{$flyer.design_bottom_text}</textarea>
        </td>
      </tr>
      ...
      <tr class="img_01">
        ...
        <td>
          <span class="alert">※</span> 登録できる画像ファイル形式はJPEG,GIF,PNGです<br />
          <iframe name="upload" class="upload" src="../ajax/upload.php?c=img_01&t=image/*" frameborder="0"
            allowtransparency="true"></iframe>
          <div class="upload_img">
      ...
      <tr class="img_02">
        <td>
          <iframe name="upload" class="upload" src="../ajax/upload.php?c=img_02&t=image/*" frameborder="0"
            allowtransparency="true"></iframe>
          <div class="upload_img">
      ...
      <tr class="img_03">
        <td>
          <iframe name="upload" class="upload" src="../ajax/upload.php?c=img_03&t=image/*" frameborder="0"
            allowtransparency="true"></iframe>
          <div class="upload_img">
