  ...
  <form id="form">
    ...
    <table class="member form">
      <tr class="company">
        ...
        <td><input type="text" name="company" class="company" value="{$company.company}" placeholder="会社名" required />
        </td>
      </tr>
      ...
      <tr class="representative">
        ...
        <td><input type="text" name="representative" value="{$company.representative}" placeholder="代表者名" required /></td>
      </tr>
      <tr class="zip">
      ...
      <tr class="address">
        ...
        <td>
          <input type="text" name="addr1" class=" addr1" value="{$company.addr1}" placeholder="都道府県" required />
          <input type="text" name="addr2" class=" addr2" value="{$company.addr2}" placeholder="市区町村" required />
          <input type="text" name="addr3" class=" addr3" value="{$company.addr3}" placeholder="番地その他" required />
        </td>
      </tr>
      <tr class="address">
        <th>緯度・経度</th>
      ...
      <tr class="website">
        <th>ウェブサイトURL</th>
        <td>
          <input type="url" name="website" class="website" value="{$company.website}"
