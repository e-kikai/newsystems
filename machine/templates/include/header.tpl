...
<div class="main_container">
  <header class="mini">
    ...
    >
      <img src='imgs/logo_machinelife_mini.png'
        alt="中古機械情報 マシンライフ 中古旋盤,中古フライス等の中古機械情報をご提供"
        title="全機連 中古機械情報" />
    </a>
  ...
  {if !isset($pankuzu) || $pankuzu !== false}
    <div class="pankuzu">
      <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
        <a href="./"
          {* onClick="_gaq.push(['_trackEvent', 'pankuzu', 'toppage', 'pankuzu', 1, true]);" *}
      ...
      {if !empty($pankuzu)}
        {foreach $pankuzu as $k => $p}
          <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="{$k}"
              {* onClick="_gaq.push(['_trackEvent', 'pankuzu', 'other', '{$k}', 1, true]);" *}
