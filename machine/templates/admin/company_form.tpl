...
*}
  ...
  <tr class="tel">
    ...
    <td><input type="tel" name="contact_tel" class="tel" value="{$company.contact_tel}" placeholder="例) XXXX-YY-ZZZZ" required /></td>
  </tr>
  
  <tr class="fax">
    <th>問い合わせFAX<span class="required">(必須)</span></th>
    <td><input type="tel" name="contact_fax" class="fax" value="{$company.contact_fax}" placeholder="例) XXXX-YY-ZZZZ" required /></td>
  </tr>
  
  <tr class="mail">
    <th>問い合わせメールアドレス</th>
    <td>
      <input type="email" name="contact_mail" class="mail" value="{$company.contact_mail}" placeholder="aaa@bbbb.com" />
    </td>
  {*** 追加分 ***}
  <tr class="infos pr">
    <th>PR</th>
    <td>
      <textarea name="infos[pr]" class="infos pr" 
        placeholder="会社のキャッチコピーなど">{$company.infos.pr}</textarea>
    </td>
  </tr>
  ...
  <tr class="infos comment">
    <th>コメント</th>
    <td>
      <textarea name="infos[comment]" class="infos comment" 
        placeholder="会社の紹介文など">{$company.infos.comment}</textarea>
    </td>
  </tr>
  ...
  <tr class="infos opening">
    <th>営業時間</th>
    <td>
      <input type="text" name="infos[opening]" class="infos opening" 
        value="{$company.infos.opening}" placeholder="営業時間を入力" />
    </td>
  </tr>
  ...
  <tr class="infos opening">
    <th>定休日</th>
    <td>
      <input type="text" name="infos[holiday]" class="infos holiday" 
        value="{$company.infos.holiday}" placeholder="定休日を入力" />
    </td>
  </tr>
  ...
  <tr class="infos license">
    <th>古物免許</th>
    <td>
      <input type="text" name="infos[license]" class="infos license" 
        value="{$company.infos.license}" placeholder="古物免許の番号" />
    </td>
  </tr>
    ...
    <td>
      ...
      {if !empty($company.offices)}
        {foreach $company.offices as $o}
          <div class="office">
            営業所・倉庫名 <input type="text" name="offices_name[]" class="offices_name" 
              value="{$o.name}" placeholder="営業所・倉庫名" /><br />
              
            〒 <input type="text" name="offices_zip[]" class="zip" value="{$o.zip}" 
              placeholder="XXX-YYYY" />
            <button class="zip2address">〒⇛住所</button><br />
              
            住所 <input type="text" name="offices_addr1[]" class="addr1" 
              value="{$o.addr1}" placeholder="都道府県" />
            <input type="text" name="offices_addr2[]" class="addr2" 
              value="{$o.addr2}" placeholder="市区町村" />
            <input type="text" name="offices_addr3[]" class="addr3" 
              value="{$o.addr3}" placeholder="番地その他" /><br />
            
            緯度経度(住所から自動入力) <input type="text" name="offices_lat[]" class="lat" value="{$o.lat}" placeholder="緯度(住所から自動入力)" />
  ...
  <tr class="top_img">
    ...
    <td>
      ...
      <iframe name="upload" class="upload" src="../ajax/upload.php?c=top_img&t=image/jpeg"
