...
*}
  ...
  <table class="info form">
    ...
    <tr class="open">
      ...
      <td>
        <input type="text" name="entry_start_date" class="entry_start date"
          value="{$bidOpen.entry_start_date|date_format:'%Y/%m/%d'}" required />
        <input type="text" name="entry_start_time" class="entry_start time"
          value="{$bidOpen.entry_start_date|date_format:'%H:%M'}" required />
        ～
        <input type="text" name="entry_end_date" class="entry_end date"
          value="{$bidOpen.entry_end_date|date_format:'%Y/%m/%d'}" required />
        <input type="text" name="entry_end_time" class="entry_end time"
          value="{$bidOpen.entry_end_date|date_format:'%H:%M'}" required />
      </td>
    </tr>
    ...
    <tr class="bid">
      ...
      <td>
        <input type="text" name="preview_start_date" class="preview_start_date date"
          value="{$bidOpen.preview_start_date|date_format:'%Y/%m/%d'}" required />
        ～
        <input type="text" name="preview_end_date" class="preview_end_date date"
          value="{$bidOpen.preview_end_date|date_format:'%Y/%m/%d'}" required />
      </td>
    </tr>
    ...
    <tr class="bid">
      ...
      <td>
        <input type="text" name="bid_start_date" class="bid_start date"
          value="{$bidOpen.bid_start_date|date_format:'%Y/%m/%d'}" required />
        <input type="text" name="bid_start_time" class="bid_start time"
          value="{$bidOpen.bid_start_date|date_format:'%H:%M'}" required />
        ～
        <input type="text" name="bid_end_date" class="bid_end date" value="{$bidOpen.bid_end_date|date_format:'%Y/%m/%d'}"
          required />
        <input type="text" name="bid_end_time" class="bid_end time" value="{$bidOpen.bid_end_date|date_format:'%H:%M'}"
          required />
      </td>
    </tr>
    ...
    <tr class="bid">
      ...
      <td>
        <input type="text" name="user_bid_date" class="user_bid date"
          value="{$bidOpen.user_bid_date|date_format:'%Y/%m/%d'}" required />
        <input type="text" name="user_bid_time" class="user_bid time" value="{$bidOpen.user_bid_date|date_format:'%H:%M'}"
          required />
      </td>
    </tr>
  ...
  *}
    ...
    <tr class="billing_date">
      ...
      <td>
        <input type="text" name="billing_date" class="billing_date date"
          value="{$bidOpen.billing_date|date_format:'%Y/%m/%d'}" required />
      </td>
    </tr>
    ...
    <tr class="payment_date">
      ...
      <td>
        <input type="text" name="payment_date" class="payment_date date"
          value="{$bidOpen.payment_date|date_format:'%Y/%m/%d'}" required />
      </td>
    </tr>
    ...
    <tr class="carryout">
      ...
      <td>
        <input type="text" name="carryout_start_date" class="carryout_start_date date"
          value="{$bidOpen.carryout_start_date|date_format:'%Y/%m/%d'}" required />
        {*
      ...
      *}
        ～
        <input type="text" name="carryout_end_date" class="carryout_end_date date"
          value="{$bidOpen.carryout_end_date|date_format:'%Y/%m/%d'}" required />
        {*
