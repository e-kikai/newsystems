...
{/literal}
  ...
  <meta name="description"
    content="全機連が主催する全国展開の中古工作機械・工具のWeb入札会。開催日程や入札への参加方法などをご案内。" />
...
<div class="lp_01_title" style="position:absolute;top: 22px;left: 48px;text-align:left;width:600px;">{$bidOpen.title|escape|regex_replace:'/(Web入札会|([a-zA-Z])+|([^a-zA-Z])+)/':'<span>$1</span>' nofilter}</div>
<span class="lp_01_title" style="position:relative;top:-360px;left:330px;"><a class="mylist" href="#" target="_blank"><img src="./imgs/lp_01_r_bot.png"　alt="全機連Web入札会のご案内"></a></span>
...
{foreach $bidMachineList as $m}
  <div class="thumb_img"><img  src="{$_conf.media_dir}machine/{$m['top_img']}" style="max-height:147px;max-width:196px;" /></div>
{/foreach}
...
<div class="lp_01_txt">
<div style="float:right;padding:10px;"><img src="../imgs/lp_01_img01.jpg"></div>全日本機械業連合会（略称：全機連）が主催し、中古機械販売のプロ（全機連会員企業）が厳選された中古機械を出品するウェブ形式の中古機械入札会です。複数の会社がウェブで合同で開催する形式は日本で唯一の仕組みで、入札希望企業様にとっては、よりたくさんの機械情報から、最適な機械を希望の価格で入札頂くことができます。また、高額で専門性の高い商品の入札をより円滑に、より安心してご参加頂けるように、全国数百社の機械販売業者により1962年に設立された全日本機械業連合会が主催している点も当ウェブ入札会の大きな特徴になっています。<br clear="both"></div>
...
<div style="float:right;padding:10px;"><img src="../imgs/lp_01_img02.jpg"></div>全日本機械業連合会（全機連）は、日本全国において工作機械、鍛圧機械を取り扱う事業者、および、事業法人によって運営されている唯一の非営利団体です。全機連は、全国の数百社に及ぶ、機械販売業者により 1962 年に設立されました。<br /><br />
...
<div class="right">
  <a class="form_button" href="./imgs/2019schedule.pdf" target="_blank"><img src="./imgs/2014schedule.png" alt="2019年Web入札会日程(スケジュール)"></a>
</div>
...
<div style="margin:0 0 20px 50px;width:800px;" class="lp_01_txt">オークションと異なり、価格がせり上がっていく仕組みではないので、ユーザー企業にとっては、冷静な御判断の元、希望価格で落札していただけるメリットがございます。</div>

<div style="" class="lp_01_cont5tit">② 面倒な交渉は業者におまかせ！</div>
<div style="margin:0 0 20px 50px;width:800px;" class="lp_01_txt">また、機械業者がユーザー企業に代わって入札を行いますので、価格交渉や専門的な知識を必要とせずに参加いただけることも大きなメリットです。</div>

<div style="" class="lp_01_cont5tit">③ 掘り出しものもたくさん発見？！</div>
<div style="margin:0 0 20px 50px;width:800px;" class="lp_01_txt">細かな工具や設備棚などの出品もあります。必要なものが見つかればお買い得は間違いなしですね！また、工作機械は製造業にとって、「ものづくりの道具」になります。様々な道具を情報収集することで、生産コストを大幅に改善できる可能性もございます。</div>
