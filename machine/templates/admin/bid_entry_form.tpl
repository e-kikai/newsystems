...
<table class="machine form">
  ...
  <tr class="officer">
    ...
    <td>
      <input type="text" name="officer" class="officer" value="{$company.bid_entries.officer}" placeholder="入札会の出品担当者" required />
    </td>
  </tr>
  ...
  <tr class="branch">
    ...
    <td>
      <input type="text" name="branch" class="branch" value="{$company.bid_entries.branch}" placeholder="支店名" required />
    </td>
  </tr>
  ...
  <tr class="number">
    ...
    <td>
      <input type="text" name="number" class="number number" value="{$company.bid_entries.number}" placeholder="数値入力" required />
    </td>
  </tr>
  <tr class="name">
