  ...
  <form id="form">
    ...
    <table class="member form">
      ...
      <tr>
        ...
        <td>
          タイトル<br />
          <input type="text" name="company_configs[top_summary_title]" value="{$site.company_configs.top_summary_title}"
    ...
    <table class="member form">
      <tr>
        ...
        <td>
          タイトル<br />
          <input type="text" name="company_configs[company_top_title]" value="{$site.company_configs.company_top_title}"
