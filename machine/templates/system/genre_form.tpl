  ...
  <form id="form">
    ...
    <table class="member form">
      ...
      <tr class="genre">
        ...
        <td>
          <input type="text" name="genre" value="{$genre.genre}" placeholder="ジャンル名" required />
        </td>
      </tr>
      ...
      <tr class="genre">
        <th>ジャンル名(カナ)</th>
        <td>
          <input type="text" name="genre_kana" value="{$genre.genre_kana}" placeholder="ジャンル名(カナ)" />
        </td>
      </tr>
...
*}
      ...
      <tr class="order_no">
        ...
        <td>
          <input type="number" class="digits num" name="order_no" value="{$genre.order_no}" placeholder="並び順(整数)"
            required />
        </td>
      </tr>
    </table>
