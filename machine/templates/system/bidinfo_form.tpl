    ...
    <script type="text/javascript">
      $(function() {
        ...
        $('button.submit').click(function() {
          ...
          //// 画像ファイルの削除 ////
          if ($('#file_delete').prop('checked')) { alert('true');
            data['data[banner_file]'] = ''; }
...
{block 'main'}
  ...
  <table class="member form">
    <tr class="bid_name">
      ...
      <td><input type="text" name="bid_name" class="bid_name" value="{$bidinfo.bid_name}" placeholder="入札会名" required />
      </td>
    </tr>
    ...
    <tr class="organizer">
      ...
      <td><input type="text" name="organizer" class="organizer" value="{$bidinfo.organizer}" placeholder="主催者名"
          required /></td>
    </tr>
    ...
    <tr class="bid">
      ...
      <td>
        <input type="text" name="bid_date" class="bid_date date" value="{$bidinfo.bid_date|date_format:'%Y/%m/%d'}"
          required />
        <input type="text" name="bid_time" class="bid_time time" value="{$bidinfo.bid_date|date_format:'%H:%M'}"
          required />
      </td>
    </tr>
