...
{block 'main'}
  ...
  <table class="member form">
    <tr class="company">
      ...
      <td><input type="text" name="user_name" class="user_name" value="{$user.user_name}" placeholder="ユーザ名" required />
      </td>
    </tr>
    ...
    <tr class="company">
      ...
      <td><input type="text" name="account" class="account" value="{$user.account}" placeholder="ユーザ名" required /></td>
    </tr>

    <tr class="company">
      {if empty($user.id)}
        <th>パスワード<span class="required">(必須)</span></th>
        <td><input type="text" name="passwd" class="passwd" value="" placeholder="パスワード" required /></td>
      {else}
        <th>パスワード変更</th>
